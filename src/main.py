...
from functions.convert_size import convert_size
import serial
...
winsound.PlaySound('startup_checking.wav', winsound.SND_FILENAME)
speak("Starting Up the system...")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "jarvis" in permission or "wake up" in permission:
            winsound.PlaySound('start_up_sound.mp3', winsound.  SND_FILENAME)
            TaskExecution()
